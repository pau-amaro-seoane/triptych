...
* 
 10   dMmax = 0.1d0*getMass(idstar)
      dRmax = 1.d0*getRadius(idstar)
      dYmax = 0.1d0
      dZmax = 0.1d0
...
*
      ...
      parameter(pts1=0.05,pts2=0.01,pts3=0.02)
...
C                  if(tmold.eq.0.d0) tmold=1.d-30
